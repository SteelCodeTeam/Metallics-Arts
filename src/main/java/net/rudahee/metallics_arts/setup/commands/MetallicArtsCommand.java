        ...
        dispatcher.register(Commands.literal("metallic").requires(commandSource -> commandSource.hasPermission(0))
                .then(Commands.literal("get")
                        ...
                        .then(Commands.literal("allomantic")
                                ...
                                .then(Commands.literal("bronze")
                                        .then(Commands.argument("target",EntityArgument.player())
                                                .executes(context -> getAllomanticPower(context,MetalsNBTData.BRONZE)))
                                )
                        ...
                        .then(Commands.literal("feruchemic")
                                ...
                                .then(Commands.literal("bronze")
                                        .then(Commands.argument("target",EntityArgument.player())
                                                .executes(context -> getFeruchemicPower(context,MetalsNBTData.BRONZE)))
                                )
                                .then(Commands.literal("zinc")
                                        .then(Commands.argument("target",EntityArgument.player())
                ...
                .then(Commands.literal("add")
                        ...
                        .then(Commands.literal("allomantic")
                                ...
                                .then(Commands.literal("bronze")
                                        .then(Commands.argument("target",EntityArgument.player())
                                                .executes(context -> addAllomanticPower(context,MetalsNBTData.BRONZE)))
                                )
                                .then(Commands.literal("zinc")
                                        .then(Commands.argument("target",EntityArgument.player())
                        ...
                        .then(Commands.literal("feruchemic")
                                ...
                                .then(Commands.literal("bronze")
                                        .then(Commands.argument("target",EntityArgument.player())
                                                .executes(context -> addFeruchemicPower(context,MetalsNBTData.BRONZE)))
                                )
                                .then(Commands.literal("zinc")
                                        .then(Commands.argument("target",EntityArgument.player())
                ...
                .then(Commands.literal("remove")
                        ...
                        .then(Commands.literal("allomantic")
                                ...
                                .then(Commands.literal("bronze")
                                        .then(Commands.argument("target",EntityArgument.player())
                                                .executes(context -> removeAllomanticPower(context,MetalsNBTData.BRONZE)))
                                )
                                .then(Commands.literal("zinc")
                                        .then(Commands.argument("target",EntityArgument.player())
                        ...
                        .then(Commands.literal("feruchemic")
                                ...
                                .then(Commands.literal("bronze")
                                        .then(Commands.argument("target",EntityArgument.player())
                                                .executes(context -> removeFeruchemicPower(context,MetalsNBTData.BRONZE)))
                                )
                                .then(Commands.literal("zinc")
                                        .then(Commands.argument("target",EntityArgument.player())
