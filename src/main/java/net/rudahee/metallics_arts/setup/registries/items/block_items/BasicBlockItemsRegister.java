...
import net.rudahee.metallics_arts.modules.custom_block_entities.distillery.DistilleryBlockItem;
...
public class BasicBlockItemsRegister {
    public static void register() {
        ...
        ModItemsRegister.DISTILLERY = MetallicsArts.registerItem("distillery",
                ()-> new DistilleryBlockItem(ModBlocksRegister.DISTILLERY.get(),
