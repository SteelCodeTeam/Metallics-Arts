package net.rudahee.metallics_arts.modules.custom_entities.haze_killer.haze_killer_ranged_entity;
...
public class HazeKillerRangedEntityModel extends EntityModel<HazeKillerRangedEntity> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MetallicsArts.MOD_ID, "haze_killer_ranged_entity"), "main");
    ...
    public HazeKillerRangedEntityModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(HazeKillerRangedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
