package net.rudahee.metallics_arts.modules.custom_entities.ferrin.gold_ferrin_entity;// Made with Blockbench 4.6.5
...
public class GoldFerrinEntityModel extends EntityModel<GoldFerrinEntity> {
    ...
    public GoldFerrinEntityModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(GoldFerrinEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
