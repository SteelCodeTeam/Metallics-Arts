...
public class HazeKillerRangedEntity extends Animal implements RangedAttackMob {
    public HazeKillerRangedEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }
    ...
    public static boolean canSpawn(EntityType<HazeKillerRangedEntity> entityType, LevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
