package net.rudahee.metallics_arts.modules.custom_entities.haze_killer_tank_entity;
...
public class HazeKillerTankEntityModel extends EntityModel<HazeKillerTankEntity> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MetallicsArts.MOD_ID, "haze_killer_tank_entity"), "main");
    ...
    public HazeKillerTankEntityModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(HazeKillerTankEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
