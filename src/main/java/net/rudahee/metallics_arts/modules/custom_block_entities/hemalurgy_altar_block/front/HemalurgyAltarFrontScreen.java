...
public class HemalurgyAltarFrontScreen extends AbstractContainerScreen<HemalurgyAltarFrontMenu> {
    ...
    public HemalurgyAltarFrontScreen(HemalurgyAltarFrontMenu menu, Inventory inv, Component component) {
