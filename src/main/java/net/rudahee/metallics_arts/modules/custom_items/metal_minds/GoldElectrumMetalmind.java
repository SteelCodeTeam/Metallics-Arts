 ...
 *
 */
public class GoldElectrumMetalmind extends MetalmindAbstract {
     ...
     */
    public GoldElectrumMetalmind(Item.Properties properties, MetalmindType type) {
        super(properties, MetalTagEnum.GOLD, MetalTagEnum.ELECTRUM, type);
    }
