...
/**
 * ItemException is a custom exception class that extends Exception.
 ...
 * <p>
 * ItemException contains an ErrorTypes enum field, which holds the error information.
...
public class ItemException extends Exception {
     ...
     */
    public ItemException(ErrorTypes errorType) {
        super();
