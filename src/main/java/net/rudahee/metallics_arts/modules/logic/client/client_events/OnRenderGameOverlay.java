...
public class OnRenderGameOverlay {
    ...
    @OnlyIn(Dist.CLIENT)
    public static void onRenderGameOverlayEvent(RenderLevelStageEvent event, Minecraft minecraft, @Nullable Player player, @Nullable IInvestedPlayerData capability) throws PlayerException {
