...
public class ClientEventHandler {
    ...
    public void onRenderLevelStage(final RenderLevelStageEvent event) {
        try {
            OnRenderGameOverlay.onRenderGameOverlayEvent(event, Minecraft.getInstance(), Minecraft.getInstance().player, CapabilityUtils.getCapability(Minecraft.getInstance().player));
        } catch (PlayerException ex) {
            ex.printCompleteLog();
        }
    }
