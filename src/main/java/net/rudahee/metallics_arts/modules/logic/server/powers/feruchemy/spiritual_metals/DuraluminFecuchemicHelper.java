    ...
    public void tapPower(Player player) {
        if (OnTickUtils.activationEvery30Tick(OnWorldTickEvent.getActualTick())) {
            ...
            if (biome.equals(Biomes.JUNGLE) || biome.equals(Biomes.BAMBOO_JUNGLE) ||biome.equals(Biomes.SPARSE_JUNGLE)) {
                player.addEffect(new MobEffectInstance(MobEffects.JUMP, 40, 3, false, false));
            ...
            // if biome is swamp
                ...
                player.addEffect(new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 40, 3, false, false));
            ...
            // if biome is savanna
                ...
                player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 5, false, false));
            // if biome is forest
            ...
            // if biome is peaks
                ...
                player.addEffect(new MobEffectInstance(MobEffects.JUMP, 40, 2, false, false));
                player.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, 40, 1, false, false));
            // if biome is water without ice
                ...
                player.addEffect(new MobEffectInstance(MobEffects.WATER_BREATHING, 40, 1, false, false));
                player.addEffect(new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 40, 2, false, false));
            ...
            // if biome is hills or slopes
                ...
                player.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, 40, 1, false, false));
                player.addEffect(new MobEffectInstance(MobEffects.JUMP, 40, 4, false, false));
            // if biome is beach
            ...
            // if biome is caves
                ...
                player.addEffect(new MobEffectInstance(MobEffects.JUMP, 40, 1, false, false));
                player.addEffect(new MobEffectInstance(MobEffects.NIGHT_VISION, 40, 1, false, false));
            // if biome is nether forest
            } else if (biome.equals(Biomes.WARPED_FOREST) || biome.equals(Biomes.CRIMSON_FOREST)) {
                player.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 40, 3, false, false));
            // if biome is nether
    ...
    public void storagePower(Player player) {
        if (OnTickUtils.activationEvery30Tick(OnWorldTickEvent.getActualTick())) {
            ...
            // if biome is desert
                ...
                player.addEffect(new MobEffectInstance(MobEffects.POISON, 40, 1, false, false));
            // if biome is plains
            } else if (biome.equals(Biomes.PLAINS) || biome.equals(Biomes.SNOWY_PLAINS) || biome.equals(Biomes.SUNFLOWER_PLAINS) ||
                    biome.equals(Biomes.MEADOW) || biome.equals(Biomes.MUSHROOM_FIELDS)) {
                player.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, 40, 2, false, false));
                player.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, 40, 2, false, false));
            // if biome is swamp
            } else if (biome.equals(Biomes.SWAMP) || biome.equals(Biomes.MANGROVE_SWAMP)) {
                player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 2, false, false));
