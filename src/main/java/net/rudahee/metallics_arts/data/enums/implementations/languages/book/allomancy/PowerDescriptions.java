...
public enum PowerDescriptions {
    ...
    TIN("Heightens your senses.",
            "\\\n Aumenta tus sentidos.",
            "Wyostrza twoje zmysły."),
    PEWTER("Increases your physical capabilities.",
    ...
    MALATIUM("Draws a line towards the last kill point of the player you hit.",
