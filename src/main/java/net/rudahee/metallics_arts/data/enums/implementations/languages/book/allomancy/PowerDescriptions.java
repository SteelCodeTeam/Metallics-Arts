...
public enum PowerDescriptions {
    ...
    ALUMINUM("Drain your Allomantic reserves. \\\\ Bonus: \\ - The greater the reserve you consume, the greater the probability of removing other adverse effects.","Vacía tus reservas alománticas. $(br)$(br)$(br) Extra: $(br) - Cuanto mayor sea la cantidad que quemes, mayor será la probabilidad de remover tus efectos de estado (tanto positivos como negativos)."),
