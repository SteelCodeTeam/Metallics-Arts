...
public enum MultiCaftDescriptions {
    ...
    PATTERNS("Design patterns for bannery with the symbols of metals, both allomantic and feruchemical.",
    ...
    CORES("Enhancement Cores that allow you to turn mundane items and armor into something superior.",
            ...
            ""),
    ALUMINUM_ARMOR("Armor with great resistance, also protects the wearer from the magic performed by enemies.",
            "Armadura de gran resistencia, que protege al portador de las magias realizadas por enemigos.",
            ""),
    STEEL_ARMOR("Armor of high resistance, that ignores the simple and mundane pushes not empowered by magic.",
