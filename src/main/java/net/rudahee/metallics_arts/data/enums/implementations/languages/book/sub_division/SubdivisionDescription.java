...
public enum SubdivisionDescription {
    ...
    CAFTING(new String[]{"",""},
            new String[]{"",""},
            new String[]{"",""}),
    ALLOY_FURNACE(new String[]{"",""},
            new String[]{"",""},
            new String[]{"",""}),

    PHYSICAL_ALLOMANCY(new String[]{""},
    ...
    DIVINE_ALLOMANCY(new String[]{""},
            ...
            new String[]{""}),
    TUTORIAL_ALLOMANCY(new String[]{""},
            new String[]{""},
            new String[]{""}),

    PHYSICAL_FERUCHEMY(new String[]{""},
