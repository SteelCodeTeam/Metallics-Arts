...
public enum SubdivisionDescription {
    ...
    PHYSICAL_ALLOMANCY(
            new String[]{"Within the group of physical metals, you will find those that allow us to interact with the physical plane. Move objects and increase our abilities."},
            ...
            new String[]{""}),
    MENTAL(
            new String[]{"Mental metals, as their name suggests, allow us to interact with the minds of others and defend our own from external contact."},
    ...
    TEMPORAL(
            ...
            new String[]{""}),
    ENHANCEMENT(
            new String[]{"Enhancement metals allow an Allomancer to empower this art, or deny it entirely."},
    ...
    TUTORIAL_ALLOMANCY(
            ...
            new String[]{""}),
    PHYSICAL_FERUCHEMY(
            new String[]{"Physical type metals are what allow a feruchemist to weaken his body in order to be stronger when necessary."},
            ...
            new String[]{""}),
    COGNITIVE(
            new String[]{"Cognitive type metals allow you to accumulate the mental capacities of your body, from the heat you feel, to your experiences and thus use them when necessary."},
    ...
    HYBRID(
            ...
            new String[]{""}),
    DIVINE_FERUCHEMY(
            new String[]{"Of the legendary divine metals, as in Allomancy, little is known, although certain supernatural effects are mentioned, even within the Investiture itself."},
    ...
    ALLOMANCY(new String[]{"The art of Allomancy is brutal, raw, and powerful. This art allows us to obtain great power from ingested metals, burning them inside us, as if it were an oven."},
