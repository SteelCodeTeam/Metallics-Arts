...
public class ModLanguageProviderPL extends LanguageProvider {
    ...
    private final Map<String, String> base = new HashMap<>() {{
        ...
        put("metallics_arts.patchouli.name_book", CTW.METALLICS_ARTS.getNameInPolish() + ": " + CTW.GUIDE.getNameInPolish());
        ...
        put("item.metallics_arts.cristal_dagger", CTW.CRISTAL_DAGGER.getNameInPolish());
